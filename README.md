📚 EduTech - Plataforma de Gestión de Tareas Académicas
    ...
    EduTech es una aplicación web desarrollada en ASP.NET Core MVC que permite a instituciones educativas gestionar de manera eficiente las       tareas académicas, facilitando la comunicación entre docentes y estudiantes a través de una interfaz intuitiva y un sistema visual de         seguimiento basado en semáforos.
...
🚀 Cómo Ejecutar el Proyecto
    ...
    Acceder a: https://localhost:7123/Inicio/Dashboard
...
🙏 Agradecimientos
    ...
    Al equipo docente del curso de Proyecto de Software

    A la comunidad de desarrolladores de ASP.NET Core
