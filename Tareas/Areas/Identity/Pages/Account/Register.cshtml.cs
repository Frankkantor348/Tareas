...
namespace Tareas.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        // Si falla la asignación del rol, mostramos error y eliminamos el usuario
                    ...
                    else
                    {
                        ...
                        // 🔥 REDIRIGIR AL DASHBOARD EN LUGAR DE returnUrl
